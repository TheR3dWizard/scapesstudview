                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      4.0, 8.0, 0.0, 0.0),
                                  child: Text(
                                    'Inform us on any classes that have not been marked',
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
                                          fontFamily: 'Poppins',
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            title:
                                                                                Text('Confirmation'),
                                                                            content:
                                                                                Text('Were you present for this class'),
                                                                            actions: [
                                                                              TextButton(
                                                                            ...
                                                                            children: [
                                                                              FutureBuilder<ApiCallResponse>(
                                                                                ...
                                                                                builder: (context, snapshot) {
                                                                                  ...
                                                                                  final textMondayResponse = snapshot.data!;
                                                                                  return AutoSizeText(
                                                                                    courseItem.maybeHandleOverflow(
                                                                                      maxChars: 32,
                                                                                      replacement: '…',
                                                                                    ),
